...
class _IntroScreen extends State<IntroScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    return IntroductionScreen(
      ...
      pages: [ //set your page view here
        buildPageViewModel(pageDecoration,intro_title1,intro_description1,"assets/images/logo.png"),
        buildPageViewModel(pageDecoration,intro_title2,intro_description2,"assets/images/user_icon.png"),
        buildPageViewModel(pageDecoration,intro_title3,intro_description3,"assets/images/bin.png"),
      ...
      //skipFlex: 0,
      nextFlex: 0,
      skip: Text('Skip', style: TextStyle(color:color1),),
      next: Icon(Icons.arrow_forward, color:color1,),
  ...
  PageViewModel buildPageViewModel(PageDecoration pageDecoration,String title,String description,String image) {
    return PageViewModel(
      title: "",
      bodyWidget: Column(
        children: [
          SizedBox(height: MediaQuery.of(context).size.height*0.20,),
          Center(child: AppLargeText(text: title)),
          introImage(image),
