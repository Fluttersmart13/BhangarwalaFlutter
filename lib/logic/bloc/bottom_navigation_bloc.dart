...
class BottomNavigationBloc
  ...
  BottomNavigationBloc({required this.productListRepo})
      : assert(productListRepo != null),
        super(PageLoading());
  ...
  //
  // Future<CategoryModel> _getSecondPageData() async {
  ...
  // }
  //
  // Future<ProductModel> _getHomeCategoryData() async {
  //   ProductModel data = categoriesRepository.data;
  //   if (data == null) {
